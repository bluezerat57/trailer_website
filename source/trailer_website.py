...
ironman = media.Movie("Ironman",
                      "After being held captive in an Afghan cave, billionaire engineer Tony Stark creates a unique weaponized suit of armor to fight evil.",  # noqa
...
scott_pilgrim = media.Movie("Scott Pilgrim vs. the World",
                            "Scott Pilgrim must defeat his new girlfriend's seven evil exes in order to win her heart.",  # noqa
